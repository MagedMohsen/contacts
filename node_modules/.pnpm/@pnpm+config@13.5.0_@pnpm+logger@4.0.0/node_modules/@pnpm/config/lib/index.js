...
exports.default = async (opts) => {
    ...
    pnpmConfig.registries = {
        default: (0, getScopeRegistries_1.normalizeRegistry)(pnpmConfig.rawConfig.registry),
    ...
    if (opts.checkUnknownSetting) {
        const settingKeys = Object.keys({
            ...(_l = (_k = npmConfig === null || npmConfig === void 0 ? void 0 : npmConfig.sources) === null || _k === void 0 ? void 0 : _k.workspace) === null || _l === void 0 ? void 0 : _l.data,
            ...(_o = (_m = npmConfig === null || npmConfig === void 0 ? void 0 : npmConfig.sources) === null || _m === void 0 ? void 0 : _m.project) === null || _o === void 0 ? void 0 : _o.data,
        }).filter(key => key.trim() !== '');
        const unknownKeys = [];
    ...
    if (!pnpmConfig.ignorePnpmfile) {
        pnpmConfig.hooks = (0, pnpmfile_1.requireHooks)((_p = pnpmConfig.lockfileDir) !== null && _p !== void 0 ? _p : pnpmConfig.dir, pnpmConfig);
    }
