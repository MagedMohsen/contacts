...
function toOutput$(opts) {
    ...
    const outputs = (0, reporterForClient_1.default)(log$, {
        ...
        throttleProgress: (_g = opts.reportingOptions) === null || _g === void 0 ? void 0 : _g.throttleProgress,
        width: (_h = opts.reportingOptions) === null || _h === void 0 ? void 0 : _h.outputMaxWidth,
    });
    if ((_j = opts.reportingOptions) === null || _j === void 0 ? void 0 : _j.appendOnly) {
